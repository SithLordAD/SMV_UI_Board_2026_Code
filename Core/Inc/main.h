...
#define BCD_A_Pin GPIO_PIN_5
#define BCD_A_GPIO_Port GPIOC
#define BCD_D_Pin GPIO_PIN_6
#define BCD_D_GPIO_Port GPIOC
#define BCD_C_Pin GPIO_PIN_8
#define BCD_C_GPIO_Port GPIOC
#define BCD_B_Pin GPIO_PIN_9
#define BCD_B_GPIO_Port GPIOC
...
#define DIGIT_2_Pin GPIO_PIN_12
#define DIGIT_2_GPIO_Port GPIOC
#define DIGIT_1_Pin GPIO_PIN_2
#define DIGIT_1_GPIO_Port GPIOD
